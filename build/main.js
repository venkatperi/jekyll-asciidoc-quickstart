...
/* WEBPACK VAR INJECTION */(function($) {__webpack_require__( 103 );
...
var highlight = __webpack_require__( 107 );
...
function jslang( hljs ) {
  var jslang = __webpack_require__( 110 )( hljs );
  jslang.keywords.keyword += keywords;
  return jslang;
}

highlight.registerLanguage( 'javascript', jslang );
highlight.registerLanguage( 'bash', __webpack_require__( 111 ) );
...
/* WEBPACK VAR INJECTION */(function(jQuery) {// https://github.com/ghiculescu/jekyll-table-of-contents
(function($){
